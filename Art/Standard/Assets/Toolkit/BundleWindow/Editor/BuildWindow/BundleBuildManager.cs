...
namespace Framework.Tools.Bundle
{
    ...
    public class BundleBuildManager
    {
        ...
        public string bundleStuff
        {
            get
            {
                if (string.IsNullOrEmpty(m_bundleStuff))
                {
                    if (EditorPrefs.HasKey("BundleBuildManager_bundleStuff"))
                    {
                        m_bundleStuff = EditorPrefs.GetString("BundleBuildManager_bundleStuff");
                    }
                    else
                    {
                        m_bundleStuff = ".bundle";
                    }
                }
                return m_bundleStuff;
            }
            set
            {
                EditorPrefs.SetString("BundleBuildManager_bundleStuff", value);
                m_bundleStuff = value;
            }
        }
