...
namespace Cinemachine.Editor
{
    public static class CinemachineMenu
    {
        ...
        [MenuItem("Tools/Cinemachine/Create Virtual Camera", false, 1)]
        ...
        [MenuItem("Tools/Cinemachine/Create FreeLook Camera", false, 1)]
        ...
        [MenuItem("Tools/Cinemachine/Create Blend List Camera", false, 1)]
        ...
        [MenuItem("Tools/Cinemachine/Create State-Driven Camera", false, 1)]
        ...
        [MenuItem("Tools/Cinemachine/Create ClearShot Camera", false, 1)]
        ...
        [MenuItem("Tools/Cinemachine/Create Dolly Camera with Track", false, 1)]
        ...
        [MenuItem("Tools/Cinemachine/Create Target Group Camera", false, 1)]
        ...
        [MenuItem("Tools/Cinemachine/Create Mixing Camera", false, 1)]
        ...
        [MenuItem("Tools/Cinemachine/Create 2D Camera", false, 1)]
        private static void Create2DCamera()
        {
            InternalCreateVirtualCamera("CM vcam", true, typeof(CinemachineFramingTransposer));
        }

        [MenuItem("Tools/Cinemachine/Create Dolly Track with Cart", false, 1)]
        ...
        [MenuItem("Tools/Cinemachine/Import Example Asset Package")]
