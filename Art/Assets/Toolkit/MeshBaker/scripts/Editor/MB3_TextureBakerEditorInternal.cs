...
namespace DigitalOpus.MB.Core{
	public class MB3_TextureBakerEditorInternal{
        ...
        private static GUIContent
            ...
            texturePackingAgorithmGUIContent = new GUIContent("Unitys Pack Textures", "Unity's PackTextures: Atlases are always a power of two. Can crash when trying to generate large atlases. \n\n " +
